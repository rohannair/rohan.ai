...
<ul>
  <li class="prose text-lg leading-8 mb-4">
    ...
    participate in the growth of our global economy.
  </li>
  <li class="prose text-lg leading-8 mb-4">
    <strong class="text-green-400">Machine Learning/AI</strong>, specifically
    around solving human problems with the harnessed power of tons of overpriced
    GPUs.
  </li>
  <li class="prose text-lg leading-8 mb-4">
    <strong class="text-yellow-400">Society</strong>, specifically around
    solving real human problems like climate change, becoming a multi-planetary
    species, and educating our massively growing populations.
  </li>
